...
"use strict";angular.module("SDLMSys").constant("DEPLOYED_HOST",{URL:"http://localhost:3001"}).constant("SEARCH_HOST",{URL:"http://192.168.0.108:9200",MULTI_API:"_msearch",SINGLE_API:"_search"}).constant("PAGINATION",{ITEMS_PER_PAGE:10});
...
"use strict";function RatingCtrl(t){t.rating=0,t.getSelectedRating=function(t,n,l){console.log(t)}}angular.module("SDLMSys").controller("RatingCtrl",["$scope",RatingCtrl]);
...
"use strict";function SearchCtrl(o,e,t,s,r,n,a,c,l){function u(){o.errorLog="",o.resultLog="",o.totalDocs=0,o.resultDocs=[]}function g(e){o.me(),u(),t.searchData(e,o.privacy,o.category,o.demomode,0,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,s=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),s+=e.data.responses[i].hits.total);o.totalDocs=s}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e}),limit=30,t.searchData(e,o.privacy,o.category,o.demomode,0,limit,function(o){if(console.log(o),200==o.status&&o.data){totalCount=0;var e=[],t=o.data.responses.length;for(i=0;i<t;i++)"undefined"===o.data.responses[i].error&&(e=e.concat(o.data.responses[i].hits.hits),totalCount+=o.data.responses[i].hits.total);totalCount<limit&&(limit=totalCount);var s=[];for(j=0;j<limit;j++){var r={};r.mongo_id=e[j]._source.id,r.score=e[j]._score,s.push(r)}console.log(s),a.recommendList(s,!1,function(o){console.log(o)},function(o){console.log(o)})}},function(o){console.log(o)})}function d(e){o.isLoading=!0,t.searchData(o.query,o.privacy,o.category,o.demomode,(e-1)*o.pageSize,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,s=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),s+=e.data.responses[i].hits.total);o.totalDocs=s,o.isLoading=!1}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e})}console.log("Constructing SearchCtrl..."),o.resultDocs=[],o.errorLog="",o.submit=function(){o.isLoading=!0,g(o.query),o.isLoading=!1},o.$watch("query",function(e){o.isLoading=!0,g(e),o.isLoading=!1}),o.$watch("demomode",function(e){o.isLoading=!0,g(o.query),o.isLoading=!1}),o.$watch("category",function(e){o.isLoading=!0,g(o.query),o.isLoading=!1}),o.$watch("privacy",function(e){o.isLoading=!0,g(o.query),o.isLoading=!1}),o.pageChanged=function(o){d(o)},o.pagination={current:1},o.pageSize=l.ITEMS_PER_PAGE,o.totalDocs=0,o.getServerDocumentPath=function(o,e){return s.getDocPathNew(o,e)},o.me=function(){n.me(function(t){console.log("Result from me()"),console.log(t),e.myDetail=t.data,o.myDetail=e.myDetail},function(){$rootScope.error="Failed to fetch details"})},o.userInteract=function(e,t,s){console.log("Document Id: "+e+" - with user action : "+t+" - data : "+s);var n={doc_id:e,the_action:t,the_data:s};r.interactDocument(n,function(e){console.log(e),setTimeout(function(){o.$apply(function(){o.me()})},500)},function(o){console.log(o)})},o.openShare=function(e){o.doc_id=e,c.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:o})}}angular.module("SDLMSys").controller("SearchCtrl",["$scope","$localStorage","SearchSvc","DocumentSvc","UserActSvc","MainSvc","RecommendSvc","ngDialog","PAGINATION",SearchCtrl]);
"use strict";function ShareCtrl(o,e,t,n,c,a,r){function l(e){e.getMySharedDocs(function(e){console.log(e.data),o.sharedDocs=e.data,o.numberOfDocs=o.sharedDocs.length},function(){$rootScope.error="Failed to fetch documents information"})}console.log("Constructing ShareCtrl..."),o.sharedDocs=[],o.myid=t.myDetail._id,o.log="",o.clearLog=function(){o.log=""},l(n),o.getServerDocumentPath=function(o,e){return n.getDocPath(o,e)},o.currentPage=0,o.pageSize=r.ITEMS_PER_PAGE,o.numberOfPages=function(){return Math.ceil(o.sharedDocs/o.pageSize)},o.userInteract=function(e,t,a){console.log("Document Id: "+e+" - with user action : "+t+" - data : "+a);var r={doc_id:e,the_action:t,the_data:a};c.interactDocument(r,function(e){console.log(e),setTimeout(function(){o.$apply(function(){l(n)})},500)},function(o){console.log(o)})},o.openShare=function(e){o.doc_id=e,a.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:o})}}angular.module("SDLMSys").controller("ShareCtrl",["$scope","$timeout","$localStorage","DocumentSvc","UserActSvc","ngDialog","PAGINATION",ShareCtrl]);
"use strict";function ShareForMeCtrl(e,o,t,n,a,r,c){function i(o){o.getSharedForMeDocuments(function(o){console.log(o.data),o.type?(e.sharedTransactions=o.data,"undefined"!=typeof o.data?e.numberOfDocs=e.sharedTransactions.length:e.numberOfDocs=0):(e.sharedTransactions=[],e.numberOfDocs=0)},function(){$rootScope.error="Failed to fetch documents information"})}console.log("Constructing ShareForMeCtrl..."),e.sharedTransactions=[],e.myid=t.myDetail._id,e.log="",e.clearLog=function(){e.log=""},i(n),e.getServerDocumentPath=function(e,o){return n.getDocPath(e,o)},e.currentPage=0,e.pageSize=c.ITEMS_PER_PAGE,e.numberOfPages=function(){return Math.ceil(e.sharedTransactions/e.pageSize)},e.userInteract=function(o,t,r){console.log("Document Id: "+o+" - with user action : "+t+" - data : "+r);var c={doc_id:o,the_action:t,the_data:r};a.interactDocument(c,function(o){console.log(o),setTimeout(function(){e.$apply(function(){i(n)})},500)},function(e){console.log(e)})},e.openShare=function(o){e.doc_id=o,r.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:e})}}angular.module("SDLMSys").controller("ShareForMeCtrl",["$scope","$timeout","$localStorage","DocumentSvc","UserActSvc","ngDialog","PAGINATION",ShareForMeCtrl]);
...
"use strict";function DocumentSvc(e,o,c){var t=c.URL;return{getMines:function(o,c){e.get(t+"/mydocs").success(o).error(c)},updateInfo:function(o,c,n){e.post(t+"/updatedocument",o).success(c).error(n)},removeDoc:function(o,c,n){e.post(t+"/deletedocument",o).success(c).error(n)},getDocPathNew:function(e){return t+"/"+e},getDocPath:function(e,o){return action="view",o&&(action="download"),t+"/"+action+"?p="+e},getMyDownloadedDocs:function(o,c){e.get(t+"/mydownloadeddocuments").success(o).error(c)},getMyLikedDocs:function(o,c){e.get(t+"/mylikeddocuments").success(o).error(c)},getMyReadingDocs:function(o,c){e.get(t+"/myreadingdocuments").success(o).error(c)},getMySharedDocs:function(o,c){e.get(t+"/myshareddocuments").success(o).error(c)},getUserReadingDocs:function(o,c,n){e.get(t+"/userReadingDocs?userid="+o).success(c).error(n)},getSharedForMeDocuments:function(o,c){e.get(t+"/sharedForMeDocuments").success(o).error(c)}}}angular.module("SDLMSys").factory("DocumentSvc",["$http","$localStorage","DEPLOYED_HOST",DocumentSvc]);
...
"use strict";function RecommendSvc(e,o,c){var r=c.URL;return{recommendList:function(o,c,n,t){var m={};m.originList=o,m.wowSky=c,e.post(r+"/recommendTopN",m).success(n).error(t)}}}angular.module("SDLMSys").factory("RecommendSvc",["$http","$localStorage","DEPLOYED_HOST",RecommendSvc]);
