...
" use strict";function SearchCtrl(o,e,t,s,r,n,a,c,l){function u(){o.errorLog="",o.resultLog="",o.totalDocs=0,o.resultDocs=[]}function g(e){u(),t.searchData(e,o.privacy,o.category,o.demomode,0,o.pageSize,function(s){if(console.log(s),200==s.status){if(s.data){o.resultDocs=[];var r=s.data.responses.length,n=0;for(i=0;i<r;i++)s.data.responses[i].error?(o.errorLog=o.errorLog+s.data.responses[i].error.index+" - "+s.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(s.data.responses[i].hits.hits),n+=s.data.responses[i].hits.total);o.totalDocs=n,limit=30,t.searchData(e,o.privacy,o.category,o.demomode,0,limit,function(o){if(console.log(o),200==o.status&&o.data){n=0;var e=[],t=o.data.responses.length;for(i=0;i<t;i++)"undefined"===o.data.responses[i].error&&(e=e.concat(o.data.responses[i].hits.hits),n+=o.data.responses[i].hits.total);n<limit&&(limit=n);var s=[];for(j=0;j<limit;j++){var r={};r.mongo_id=e[j]._source.id,r.score=e[j]._score,s.push(r)}console.log(s),a.recommendList(s,!1,function(o){console.log(o)},function(o){console.log(o)})}},function(o){console.log(o)})}}else console.log(s.statusText),o.errorLog=s.statusText},function(e){o.errorLog=e})}function d(e){o.isLoading=!0,t.searchData(o.query,o.privacy,o.category,o.demomode,(e-1)*o.pageSize,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,s=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),s+=e.data.responses[i].hits.total);o.totalDocs=s,o.isLoading=!1}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e})}console.log("Constructing SearchCtrl..."),o.resultDocs=[],o.errorLog="",o.submit=function(){o.isLoading=!0,g(o.query),o.isLoading=!1},o.$watch("query",function(e){o.isLoading=!0,g(e),o.isLoading=!1}),o.$watch("demomode",function(e){o.isLoading=!0,g(o.query),o.isLoading=!1}),o.$watch("category",function(e){o.isLoading=!0,g(o.query),o.isLoading=!1}),o.$watch("privacy",function(e){o.isLoading=!0,g(o.query),o.isLoading=!1}),o.pageChanged=function(o){d(o)},o.pagination={current:1},o.pageSize=l.ITEMS_PER_PAGE,o.totalDocs=0,o.getServerDocumentPath=function(o,e){return s.getDocPathNew(o,e)},o.me=function(){n.me(function(t){console.log(t),e.myDetail=t.data,o.myDetail=e.myDetail,console.log(e.myDetail)},function(){$rootScope.error="Failed to fetch details"})},o.userInteract=function(e,t,s){console.log("Document Id: "+e+" - with user action : "+t+" - data : "+s);var n={doc_id:e,the_action:t,the_data:s};r.interactDocument(n,function(e){console.log(e),setTimeout(function(){o.$apply(function(){o.me()})},500)},function(o){console.log(o)})},o.openShare=function(e){o.doc_id=e,c.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:o})},o.me()}angular.module("SDLMSys").controller("SearchCtrl",["$scope","$localStorage","SearchSvc","DocumentSvc","UserActSvc","MainSvc","RecommendSvc","ngDialog","PAGINATION",SearchCtrl]);
