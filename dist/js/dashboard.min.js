...
"use strict";function SearchCtrl(o,e,t,n,r,s,a,c,l,u){function g(){o.errorLog="",o.resultLog="",o.totalDocs=0,o.resultDocs=[]}function d(e){o.me(),g(),t.searchData(e,o.privacy,o.category,o.demomode,0,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,n=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),n+=e.data.responses[i].hits.total);o.totalDocs=n}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e}),limit=30,t.searchData(e,o.privacy,o.category,o.demomode,0,limit,function(o){if(console.log(o),200==o.status&&o.data){totalCount=0;var e=[],t=o.data.responses.length;for(i=0;i<t;i++)"undefined"===o.data.responses[i].error&&(e=e.concat(o.data.responses[i].hits.hits),totalCount+=o.data.responses[i].hits.total);totalCount<limit&&(limit=totalCount);var n=[];for(j=0;j<limit;j++){var r={};r.mongo_id=e[j]._source.id,r.score=e[j]._score,n.push(r)}console.log(n),a.recommendList(n,!1,function(o){console.log(o)},function(o){console.log(o)})}},function(o){console.log(o)})}function f(e){o.isLoading=!0,t.searchData(o.query,o.privacy,o.category,o.demomode,(e-1)*o.pageSize,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,n=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),n+=e.data.responses[i].hits.total);o.totalDocs=n,o.isLoading=!1}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e})}console.log("Constructing SearchCtrl..."),o.resultDocs=[],o.errorLog="",o.submit=function(){o.isLoading=!0,d(o.query),o.isLoading=!1},o.category="",o.$watch("query",function(e){o.isLoading=!0,d(e),o.isLoading=!1}),o.$watch("demomode",function(e){o.isLoading=!0,d(o.query),o.isLoading=!1}),o.$watch("category",function(e){o.isLoading=!0,d(o.query),o.isLoading=!1}),o.$watch("privacy",function(e){o.isLoading=!0,d(o.query),o.isLoading=!1}),o.pageChanged=function(o){f(o)},o.pagination={current:1},o.pageSize=u.ITEMS_PER_PAGE,o.totalDocs=0,o.getServerDocumentPath=function(o,e){return n.getDocPath(o,e)},o.me=function(){s.me(function(t){console.log("Result from me()"),console.log(t),e.myDetail=t.data,o.myDetail=e.myDetail},function(){$rootScope.error="Failed to fetch details"})},o.userInteract=function(e,t,n){console.log("Document Id: "+e+" - with user action : "+t+" - data : "+n);var s={doc_id:e,the_action:t,the_data:n};r.interactDocument(s,function(e){console.log(e),setTimeout(function(){o.$apply(function(){o.me()})},500)},function(o){console.log(o)})},o.openShare=function(e){o.doc_id=e,l.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:o})},o.rating=0,o.getSelectedRating=function(o,e,t){console.log(o)}}angular.module("SDLMSys").controller("SearchCtrl",["$scope","$localStorage","SearchSvc","DocumentSvc","UserActSvc","MainSvc","RecommendSvc","CategorySvc","ngDialog","PAGINATION",SearchCtrl]);
