...
"use strict";function MainCtrl(e,o,n,t,s,i,c,l,r,d,u){console.log("Constructing MainCtrl..."),o.me=function(){console.log("Me called"),c.me(function(e){console.log(e),i.myDetail=e.data},function(){e.error="Failed to fetch details"})},o.stats={},o.currentUser={},o.userReadDocs=[],o.numberOfUserReadDocs=0,o.currentPage=0,o.recommendDocs=[],o.numberOfRecommends=0,o.pageSize=2*u.ITEMS_PER_PAGE,o.numberOfPages=function(){return Math.ceil(o.userReadDocs/o.pageSize)},o.getUserReadingDocuments=function(n){l.getUserReadingDocs(n,function(e){console.log(e.data),e.type?(o.userReadDocs=e.data,o.numberOfUserReadDocs=o.userReadDocs.length):(o.userReadDocs=[],o.numberOfUserReadDocs=0)},function(){o.userReadDocs=[],o.numberOfUserReadDocs=0,e.error="Failed to fetch documents information"})},o.getUserRecommendDocuments=function(n){r.recommendSocial(n,.2,10,function(e){if(e.type){console.log("===========Recommendation==========="),console.log(e),o.recommendDocs=[];for(var n=0;n<e.data.length;n++)o.recommendDocs.push(e.data[n].doc);o.numberOfRecommends=o.recommendDocs.length,console.log("number of recommends = "+o.numberOfRecommends),console.log(o.recommendDocs)}else o.recommendDocs=[],o.numberOfRecommends=0},function(){o.recommendDocs=[],o.numberOfRecommends=0,e.error="Failed to fetch documents information"})},o.getStatistic=function(){if(console.log("=======GET STATISTICS======="),console.log(i.myDetail),console.log("=====END GET STATISTICS====="),null==i.myDetail&&o.me(),null!=i.myDetail){var e=i.myDetail._id;o.strViewingUser=i.myDetail.username,o.bFriendRequestSent=!1,o.bSendFriendRequest=!1,o.bResponseFriendRequest=!1,o.bRequestFollowRequest=!1,o.bBeFriend=!1,console.log("=====Main====="),console.log(i.myDetail),console.log(t),console.log("=====End Main====="),""!==t.userid&&""!==i.myDetail._id?t.userid!==i.myDetail._id&&(e=t.userid,i.myDetail.friends.length>=0&&-1===i.myDetail.friends.indexOf(t.userid)?-1!==i.myDetail.wait_response_friends.indexOf(t.userid)?(console.log("Waiting for response friends"),o.bFriendRequestSent=!0):-1!==i.myDetail.request_friends.indexOf(t.userid)?(console.log("Received a friend request"),o.bResponseFriendRequest=!0):(console.log("Received a friend request"),o.bSendFriendRequest=!0,-1===i.myDetail.followers.indexOf(t.userid)&&(o.bRequestFollowRequest=!0)):o.bBeFriend=!0):""===t.userid&&""!==i.myDetail._id?e=i.myDetail._id:s.path("/"),o.myid=e,console.log(e+" - "+i.myDetail._id+" or "+t.userid),o.getUserReadingDocuments(e),o.getUserRecommendDocuments(e),c.getStatistic(e,function(e){console.log(e),o.stats=e},function(e){console.log(e)}),c.getUserInformation(e,function(e){console.log(e),e.type?o.currentUser=e.data:o.currentUser=i.myDetail,o.strViewingUser=o.currentUser.username},function(e){console.log(e)})}},o.getStatistic(),o.sendFriendRequest=function(){if(console.log("Send Friend Request"),o.bSendFriendRequest){var e={friend_id:t.userid};console.log(t),c.sendFriendRequest(e,function(e){console.log("SendRequestSuccess"),console.log(e),o.me(),setTimeout(function(){o.$apply(function(){o.getStatistic()})},500)},function(e){console.log("SendRequestFailed"),console.log(e)})}},o.sendFriendResponse=function(){if(console.log("Send Friend Response"),o.bResponseFriendRequest){var e={friend_id:t.userid};console.log(t),c.sendFriendResponse(e,function(e){console.log("SendResponseSuccess"),console.log(e),o.me(),setTimeout(function(){o.$apply(function(){o.getStatistic()})},500)},function(e){console.log("SendResponseFailed"),console.log(e)})}},o.confirmFollow=function(){if(console.log("confirm follow Response"),o.bRequestFollowRequest){console.log(t);var e={follower_id:t.userid};c.sendConfirmFollow(e,function(e){console.log("sendConfirmFollowSuccess"),console.log(e),o.me(),setTimeout(function(){o.$apply(function(){o.getStatistic()})},500)},function(e){console.log("sendConfirmFollowFailed"),console.log(e)})}},o.getServerDocumentPath=function(e,o){return l.getDocPath(e,o)},o.userInteract=function(e,n,t){console.log("Document Id: "+e+" - with user action : "+n+" - data : "+t);var s={doc_id:e,the_action:n,the_data:t};UserActSvc.interactDocument(s,function(e){console.log(e),setTimeout(function(){o.me(),o.$apply(function(){o.getStatistic()})},500)},function(e){console.log(e)})},o.openShare=function(e){o.doc_id=e,d.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:o})}}angular.module("SDLMSys").controller("MainCtrl",["$rootScope","$scope","$route","$stateParams","$location","$localStorage","MainSvc","DocumentSvc","RecommendSvc","ngDialog","PAGINATION",MainCtrl]);
...
"use strict";function RatingCtrl(t){t.rate=function(t,n,i){},t.getMyRating=function(t){}}angular.module("SDLMSys").controller("RatingCtrl",["$scope",RatingCtrl]);
...
"use strict";function SearchCtrl(o,e,t,r,s,a,n,c,l,u){function g(){o.errorLog="",o.resultLog="",o.totalDocs=0,o.resultDocs=[]}function d(e){o.me(),g(),t.searchData(e,o.privacy,o.category,0,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,r=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),r+=e.data.responses[i].hits.total);o.totalDocs=r}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e})}function f(e){o.isLoading=!0,t.searchData(o.query,o.privacy,o.category,(e-1)*o.pageSize,o.pageSize,function(e){if(console.log(e),200==e.status){if(e.data){o.resultDocs=[];var t=e.data.responses.length,r=0;for(i=0;i<t;i++)e.data.responses[i].error?(o.errorLog=o.errorLog+e.data.responses[i].error.index+" - "+e.data.responses[i].error.reason,o.resultLog="There is no document found"):(o.resultDocs=o.resultDocs.concat(e.data.responses[i].hits.hits),r+=e.data.responses[i].hits.total);o.totalDocs=r,o.isLoading=!1}}else console.log(e.statusText),o.errorLog=e.statusText},function(e){o.errorLog=e})}console.log("Constructing SearchCtrl..."),o.resultDocs=[],o.errorLog="",o.submit=function(){o.isLoading=!0,d(o.query),o.isLoading=!1},o.category="",o.$watch("query",function(e){o.isLoading=!0,d(e),o.isLoading=!1}),o.$watch("category",function(e){o.isLoading=!0,d(o.query),o.isLoading=!1}),o.$watch("privacy",function(e){o.isLoading=!0,d(o.query),o.isLoading=!1}),o.pageChanged=function(o){f(o)},o.pagination={current:1},o.pageSize=u.ITEMS_PER_PAGE,o.totalDocs=0,o.getServerDocumentPath=function(o,e){return r.getDocPath(o,e)},o.me=function(){a.me(function(t){console.log("Result from me()"),console.log(t),e.myDetail=t.data,o.myDetail=e.myDetail},function(){$rootScope.error="Failed to fetch details"})},o.userInteract=function(e,t,r){console.log("Document Id: "+e+" - with user action : "+t+" - data : "+r);var a={doc_id:e,the_action:t,the_data:r};s.interactDocument(a,function(e){console.log(e),setTimeout(function(){o.$apply(function(){o.me()})},500)},function(o){console.log(o)})},o.openShare=function(e){o.doc_id=e,l.open({template:"firstDialog",controller:"PopupShareCtrl",className:"ngdialog-theme-default ngdialog-theme-custom",scope:o})},o.rating=0,o.getSelectedRating=function(o,e,t){console.log(o)}}angular.module("SDLMSys").controller("SearchCtrl",["$scope","$localStorage","SearchSvc","DocumentSvc","UserActSvc","MainSvc","RecommendSvc","CategorySvc","ngDialog","PAGINATION",SearchCtrl]);
